    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (conversation.getUnreadMsgCount() > 0) {
            ...
            for (int i = allMessages.size() - 1; i > 0; i--) {
                try {
                    String model = allMessages.get(i).getStringAttribute("model");
                    if (!"".equals(model) && model != null) {
                        if (model.equals("privateLetter")) {
                            boolean unread = allMessages.get(i).isUnread();
                            if (unread) {
                                ind++;
                            }
                        }
            ...
            if (ind > 0) {
                ...
                holder.unreadLabel.setText(String.valueOf(ind));
