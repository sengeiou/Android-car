...
public class TripBookRecomPresneter extends WrapPresenter<TripBookFindView> {
    ...
    public void getRecomTripBookList(String lat, String lng, int page) {
        RXUtil.execute(mService.getripBookRecomenList(lat, lng, page), new Observer<ResponseMessage<TripBookModel>>() {
            @Override
