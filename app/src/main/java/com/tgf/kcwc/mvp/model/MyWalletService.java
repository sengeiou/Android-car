...
public interface MyWalletService {
    ...
    @FormUrlEncoded
    @POST("purse/account/change_password")
     ...
     * @return
     */
    @GET("purse/account/check_ver_code")
     ...
     * @return
     */
    @GET("purse/account/record_detail")
     ...
     * @return
     */
    @GET("purse/account/verify_password")
     ...
     */
    // @FormUrlEncoded
    @GET("purse/bank_card/set_selected")
     ...
     * @return
     */
    @GET("purse/bank_card/get_selected")
     ...
     */
    @FormUrlEncoded
    @POST("purse/recharge/bankcard")
    Observable<ResponseMessage<PrePaidModel>> setPrePaid(@FieldMap Map<String, String> params);
     ...
     */
    @FormUrlEncoded
    @POST("purse/recharge/wxRecharge")
    Observable<ResponseMessage<OrderPayParam>> setWXPrePaid(@FieldMap Map<String, String> params);
    ...
    @FormUrlEncoded
    @POST("purse/account/set_free_pay")
