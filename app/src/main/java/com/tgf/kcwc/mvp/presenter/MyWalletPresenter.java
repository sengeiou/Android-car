...
public class MyWalletPresenter extends WrapPresenter<MyWalletView> {
    private MyWalletView mView;
    private Subscription mSubscription;
    private MyWalletService mService = null;

    @Override
    public void attachView(MyWalletView view) {
        this.mView = view;
    ...
    public void prePaidToCard(Map<String, String> params) {
        ...
        mSubscription = RXUtil.execute(mService.setPrePaid(params),
                new Observer<ResponseMessage<PrePaidModel>>() {
                    @Override
                    public void onCompleted() {
                    ...
                    @Override
                    public void onNext(ResponseMessage<PrePaidModel> responseMessage) {
     ...
     * @param params
     */
    public void wxPrePaidToCard(Map<String, String> params) {

        mSubscription = RXUtil.execute(mService.setWXPrePaid(params),
