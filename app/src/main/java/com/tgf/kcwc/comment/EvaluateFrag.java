...
public class EvaluateFrag extends BaseFragment implements CommentListView {
     ...
     * @param modules  模块
     */
    public EvaluateFrag(List<Comment> comments, int threadId, String modules) {
        if (comments != null) {
    ...
    private CommentListView<View> mExecLikeView = new CommentListView<View>() {
        ...
        public void showDatas(View v) {
            mCommentPresenter.loadEvaluateList(mModules, mthreadId + "", "car");
        }
    ...
    private void showCommentLists() {
        ...
        mCommentsadapter = new NestFullListViewAdapter<Comment>(R.layout.listview_item_eval,
                commentArrayList) {
...
//                holder.setEmojiText(R.id.contentTv, comment.content);
                EmojiTextView contentTv  =  holder.getView(R.id.contentTv);
                contentTv.setEmojiToTextView(comment.content);
                ImageView modelImg = holder.getView(R.id.comment_model_tv);
                ImageView popmanImg = holder.getView(R.id.comment_popman_tv);
                RatingBar commentStar =  holder.getView(R.id.comment_star);
//                TextView remplyNumTv = holder.getView(R.id.reply_comments_tv);
                ...
                commentStar.setStar(NumFormatUtil.getFmtString(comment.star));
