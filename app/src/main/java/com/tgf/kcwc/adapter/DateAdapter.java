 ...
 * @describle
 */
public class DateAdapter extends RecyclerView.Adapter<DateAdapter.PavilionVh> {
    public ArrayList<ExhibitionIntervalModel.TimeSlots> list;
    ...
    public DateAdapter(Context context, ArrayList<ExhibitionIntervalModel.TimeSlots> list) {
    ...
    public void onBindViewHolder(PavilionVh holder, final int position) {
        ExhibitionIntervalModel.TimeSlots timeSlots = list.get(position);
        if (timeSlots.isSelect) {//选中
        ...
        holder.checkBox.setText(timeSlots.timeFormat);
