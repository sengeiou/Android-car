...
public class HeaderTripPlayFilterView extends AbsHeaderView<Object> implements View.OnClickListener {
    ...
    public HeaderTripPlayFilterView(Activity activity, Handler mHandler) {
        super(activity);
