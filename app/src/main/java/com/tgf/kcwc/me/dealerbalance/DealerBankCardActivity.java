...
public class DealerBankCardActivity extends BaseActivity implements DealerWalletView<List<BankCardModel>> {
    protected TextView msgTv;
    protected RelativeLayout emptyLayout;
    protected ListView list;
    protected Button addBtn;

    protected DealerWalletPresenter mPresenter;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        super.setContentView(R.layout.activity_dealer_bank_card);
