...
import com.tgf.kcwc.tripbook.TripBookMapActivity;
...
public class FavoriteFragment extends BaseFragment implements RideDataView<RideDataModel> {
    ...
    protected void initView() {
        ...
        mPresenter.loadFavoriteDatas(page + "", pageSize + "", token);
    }
    ...
    private void bindData(final RideDataModel rideDataModel) {
        ...
        WrapAdapter<RideDataModel.RideData> adapter = new WrapAdapter<RideDataModel.RideData>(
            ...
            public void convert(WrapAdapter.ViewHolder helper, RideDataModel.RideData item) {
                ...
                avatar.setImageURI(Uri.parse(URLUtil.builderImgUrl(item.cover, 144, 144)));
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (!type.equals("")) {
                    ...
                    toTripBookAct.putExtra(Constants.IntentParams.ID, data.bookId);
