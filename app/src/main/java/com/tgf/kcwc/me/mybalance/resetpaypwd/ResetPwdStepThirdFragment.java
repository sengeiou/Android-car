...
public class ResetPwdStepThirdFragment extends BaseFragment implements MyWalletView {
   public PayPwdInputView passwordInputView;
    ...
    public void showData(Object object) {
        ...
        KPlayCarApp.removeValue(Constants.KeyParams.PAY_OLD_PWD);
        getActivity().finish();
    }
    ...
    private Map<String, String> builderReqParams() {
        ...
        String oldPwd = KPlayCarApp.getValue(Constants.KeyParams.PAY_OLD_PWD);
        params.put("old_password", EncryptUtil.encode(oldPwd));
        params.put("ver_code", "");
    ...
    public void backEvent() {
        ...
        if (passwordInputView != null) {
            ...
            CommonUtils.closeSoftKeyword(passwordInputView);
        }
    }
}
