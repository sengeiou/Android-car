...
public class SelectBankCardActivity extends BaseActivity implements MyWalletView<List<BankCardModel>>, AdapterView.OnItemClickListener {
    ...
    protected MyWalletPresenter mPresenter, mSetPresenter;
    ...
    private void initView() {
        ...
        mSetPresenter = new MyWalletPresenter();
     ...
     * 设置银行卡选中View回调
     */
    private MyWalletView mSetView = new MyWalletView() {
        @Override
