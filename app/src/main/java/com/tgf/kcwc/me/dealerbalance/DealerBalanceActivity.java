...
public class DealerBalanceActivity extends BaseActivity implements DealerWalletView<AccountBalanceModel> {
    ...
    protected void titleBarCallback(ImageButton back, FunctionView function, TextView text) {
        ...
        text.setText("小金库");
        text.setTextSize(16);
        function.setTextResource("明细", R.color.white, 14);
    ...
    public void onClick(View view) {
        ...
        switch (id) {
            ...
            case R.id.prePaidLayout:
                ...
                if (isPwd == EXIST_PWD) {
                    CommonUtils.startNewActivity(mContext, PrePaidActivity.class);
                } else {
            ...
            case R.id.withdrawCashLayout:
                ...
                if (isPwd == EXIST_PWD) {
                    ...
                    CommonUtils.startNewActivity(mContext, args, WithdrawCashActivity.class);
                } else {
                    CommonUtils.startNewActivity(mContext, SettingPayPwdActivity.class);
                }
            ...
            case R.id.myBankCardLayout:
                ...
                CommonUtils.startNewActivity(mContext, args, DealerBankCardActivity.class);
                break;
        }
