...
public class SponsorStoreBelowActivity extends BaseActivity implements SponsorStoreBelowView {
    ...
    private SponsorStreBelowPresenter mSponsorStreBelowPresenter;
    ...
    protected void setUpViews() {
        ...
        mSponsorStreBelowPresenter = new SponsorStreBelowPresenter();
    ...
    protected void titleBarCallback(ImageButton back, FunctionView function, TextView text) {
        ...
        backEvent(back);
        text.setText(R.string.sponsorstorebelow);
        text.setTextSize(16);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.car_type:
                ...
                KPlayCarApp.putValue(Constants.IntentParams.SPONSORPLEASE, Constants.CarSeriesBack.SPONSORSTOREBELOW_SUCCEED);
            ...
            case R.id.facadelayout:
                ...
                isSelectColour = true;
                if (mCarSelectBean.carId == 0) {
                    mSponsorStreBelowPresenter.getCarCategoryColors(mCarSelectBean.seriesId + "","car_series", "out");
                } else {
                    mSponsorStreBelowPresenter.getCarCategoryColors(mCarSelectBean.carId + "","car", "out");
    ...
    public void dataColourSucceed(List<CarColor> datalist) {
        ...
        mDropUpColourPopupWindow.show(SponsorStoreBelowActivity.this);
