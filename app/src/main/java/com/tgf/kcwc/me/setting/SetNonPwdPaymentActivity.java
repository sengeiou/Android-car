...
public class SetNonPwdPaymentActivity extends BaseActivity {
    ...
    private MyWalletPresenter mSetNonPwdPaymentPresenter;
    ...
    protected void initView() {
        ...
        tel = mUser.tel;
        mSetNonPwdPaymentPresenter = new MyWalletPresenter();
        mSetNonPwdPaymentPresenter.attachView(myWalletView);
    ...
    MyWalletView<ResponseMessage<Object>> myWalletView = new MyWalletView<ResponseMessage<Object>>() {
        @Override
