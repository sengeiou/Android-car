...
public class DropDownKiloSpinner extends PopupWindow implements CouponCategoryListView {
    ...
    public DropDownKiloSpinner(Context context, List<DataItem> dataList) {
        ...
        catContentView.findViewById(R.id.popwin_supplier_list_bottom)
                .setOnClickListener(new View.OnClickListener() {
                    public void onClick(View arg0) {
                        DropDownKiloSpinner.this.dismiss();
                    }
                });
    }
