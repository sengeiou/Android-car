...
public class DropDownSingleSpinner extends PopupWindow {
    ...
    public DropDownSingleSpinner(Context context, List<DataItem> dataList) {
    ...
    private void initAdapter() {
        ...
        catPopListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                selectItem.isSelected = true;
                mCatgroyAdapter.notifyDataSetChanged();
                DropDownSingleSpinner.this.dismiss();
            }
        });
    }

    private void initView() {
        catContentView = View.inflate(mContext, R.layout.popwin_filter_list, null);
