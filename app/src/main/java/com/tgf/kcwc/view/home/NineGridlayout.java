package com.tgf.kcwc.view.home;
...
//        ScreenTools screenTools=ScreenTools.instance(getContext());
        totalWidth = (int) (DensityUtils.getPhonewidth(mContext) - DensityUtils.dip2px(mContext, 46));
    ...
    private void layoutChildrenView() {
        ...
        for (int i = 0; i < childrenCount; i++) {
            ...
            Glide.with(mContext)
                    .load(URLUtil.builderImgUrl(listData.get(i)))
                    .override(singleWidth, singleHeight)
                    .into(childrenView);
    ...
    public void setImagesData(List<String> lists, int morbid) {
        ...
        if(rows<3){
            ...
            totalWidth = (int) (DensityUtils.getPhonewidth(mContext) - DensityUtils.dip2px(mContext, morbid));
        }
        //这里做一个重用view的处理
        if (listData == null) {
            int i = 0;
