...
public class RangeBar extends View {
    ...
    private static final float DEFAULT_TICK_HEIGHT_DP = 4;
    private static final float DEFAULT_BAR_WEIGHT_PX = 4;
    private static final int DEFAULT_BAR_COLOR = 0xFFe0e0e0;
    private static final float DEFAULT_CONNECTING_LINE_WEIGHT_PX = 4;
    private static final int DEFAULT_THUMB_IMAGE_NORMAL = R.drawable.rangeseekbar_thumb;
    private static final int DEFAULT_THUMB_IMAGE_PRESSED = R.drawable.rangeseekbar_thumb;

    // Corresponds to android.R.color.holo_blue_light.
    // Corresponds to android.R.color.holo_blue_light. d6bd99
    private static final int DEFAULT_CONNECTING_LINE_COLOR = 0xFF36a95c;
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mLeftThumb = new Thumb(ctx, yPos, mThumbColorNormal, mThumbColorPressed, mThumbRadiusDP,
            mThumbImageNormal, mThumbImagePressed);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mLeftThumb.draw(canvas, mLeftIndex);
        mRightThumb.draw(canvas, mRightIndex);
...
//    }
    ...
    private void createBar() {
        ...
        mBar = new Bar(getContext(), getMarginLeft(), getYPos(), getBarLength(), mTickCount,
    ...
    private void createConnectingLine() {
        ...
        mConnectingLine = new ConnectingLine(getContext(), getYPos(), mConnectingLineWeight,
            mConnectingLineColor);
        invalidate();
    }
    ...
    private void onActionMove(float x) {
        ...
        if (newLeftIndex != mLeftIndex || newRightIndex != mRightIndex) {
            ...
            if (mListener != null) {
                mListener.onIndexChangeListener(this, mLeftIndex+1, mRightIndex+1);
            }
        }
    }
