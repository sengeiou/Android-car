...
public class DropUpPhonePopupWindow extends BottomPushPopupWindow<List<DataItem>>{
    ...
    public DropUpPhonePopupWindow(Context context, List<DataItem> dataList) {
        ...
        catContentView.findViewById(R.id.popwin_supplier_list_bottom)
                .setOnClickListener(new View.OnClickListener() {
                    public void onClick(View arg0) {
                        DropUpPhonePopupWindow.this.dismiss();
                    }
                });
