...
public class CicleAddAndSubView extends LinearLayout {
    ...
    int num = 1;          //数量值
    private LinearLayout mSubBtnLay;//减号点击
    private LinearLayout mAddBtnLay;//加号点击
    ...
    private void initView() {
        ...
        mSubBtnLay = (LinearLayout) view.findViewById(R.id.sub_btn_lay);
        mAddBtnLay = (LinearLayout) view.findViewById(R.id.add_btn_lay);
        setNum(num);
        addView(view);
    }
    ...
    private void setViewListener() {
        mAddBtnLay.setOnClickListener(new OnButtonClickListener());
        mSubBtnLay.setOnClickListener(new OnButtonClickListener());
    }
    ...
    private class OnButtonClickListener implements OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (TextUtils.isEmpty(numString)) {
                ...
                } else if (v.getId() == R.id.sub_btn_lay) {
                    if (--num < 1) {
                        num = 0;
                        subButton.setVisibility(View.VISIBLE);
                        editText.setVisibility(View.VISIBLE);
