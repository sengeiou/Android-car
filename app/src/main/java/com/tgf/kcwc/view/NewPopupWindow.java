...
public class NewPopupWindow extends PopupWindow {
    ...
    public NewPopupWindow(final Activity context, List<MorePopupwindowBean> data, MoreOnClickListener mMoreOnClickListe) {
        dataList = data;
        activity = context;
        ...
        mCommonAdapter = new WrapAdapter<MorePopupwindowBean>(context,
            ...
            @Override
            public void convert(ViewHolder helper, final MorePopupwindowBean item) {
        ...
        this.setHeight(DensityUtils.dip2px(context,200));
