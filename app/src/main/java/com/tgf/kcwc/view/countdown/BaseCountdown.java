...
class BaseCountdown {
    ...
    public boolean              isShowDay, isShowHour, isShowMinute, isShowSecond,
            isShowMillisecond;
    ...
    protected float             mSuffixDayTextBaseline, mSuffixHourTextBaseline,
            mSuffixMinuteTextBaseline, mSuffixSecondTextBaseline, mSuffixMillisecondTextBaseline;
    protected float             mTimeTextWidth, mTimeTextHeight, mTimeTextBottom;
    protected int               mSuffixGravity;

    private boolean             hasSetSuffixDay, hasSetSuffixHour, hasSetSuffixMinute,
            hasSetSuffixSecond, hasSetSuffixMillisecond;
    ...
    public void initStyleAttr(Context context, TypedArray ta) {
        ...
        mSuffixTextSize = ta.getDimension(R.styleable.CountdownView_suffixTextSize,
            Utils.sp2px(mContext, 12));
        ...
        mSuffixHourRightMargin = ta.getDimension(R.styleable.CountdownView_suffixHourRightMargin,
            -1);
        mSuffixMinuteLeftMargin = ta.getDimension(R.styleable.CountdownView_suffixMinuteLeftMargin,
            -1);
        mSuffixMinuteRightMargin = ta
            .getDimension(R.styleable.CountdownView_suffixMinuteRightMargin, -1);
        mSuffixSecondLeftMargin = ta.getDimension(R.styleable.CountdownView_suffixSecondLeftMargin,
            -1);
        mSuffixSecondRightMargin = ta
            .getDimension(R.styleable.CountdownView_suffixSecondRightMargin, -1);
        mSuffixMillisecondLeftMargin = ta
            .getDimension(R.styleable.CountdownView_suffixMillisecondLeftMargin, -1);
    ...
    private void initSuffixBase() {
        ...
        if ((isShowDay && hasSetSuffixDay) || (isShowHour && hasSetSuffixHour)
            || (isShowMinute && hasSetSuffixMinute) || (isShowSecond && hasSetSuffixSecond)
    ...
    protected final float getAllContentWidthBase(float timeWidth) {
        ...
        width += (mSuffixDayLeftMargin + mSuffixDayRightMargin + mSuffixHourLeftMargin
                  + mSuffixHourRightMargin + mSuffixMinuteLeftMargin + mSuffixMinuteRightMargin
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (isShowHour) {
            // draw hour text
            canvas.drawText(Utils.formatNum(mHour), mHourLeft + mTimeTextWidth / 2,
                mTimeTextBaseline, mTimeTextPaint);
        ...
        if (isShowSecond) {
            ...
            if (isShowMillisecond) {
                ...
                canvas.drawText(Utils.formatMillisecond(mMillisecond),
                    mMillisecondLeft + mTimeTextWidth / 2, mTimeTextBaseline, mTimeTextPaint);
    ...
    public boolean setSuffix(String suffixDay, String suffixHour, String suffixMinute,
                             String suffixSecond, String suffixMillisecond) {
        boolean isRef = false;
    ...
    public void setSuffixLRMargin(float suffixLRMargin) {
        ...
        setSuffixMargin(mSuffixDayLeftMargin, mSuffixDayLeftMargin, mSuffixDayLeftMargin,
            mSuffixDayLeftMargin, mSuffixDayLeftMargin, mSuffixDayLeftMargin, mSuffixDayLeftMargin,
