package com.tgf.kcwc.view.mapview;
 ...
 * 导航路线图层类。
 */
public class DrivingRouteSearchOverlay extends RouteSearchOverlay {
     ...
     */
    public DrivingRouteSearchOverlay(Context context, AMap amap, DrivePath path,
...
//            addStartAndEndMarker();
    ...
    private BitmapDescriptor getThroughPointBitDes() {
    	return BitmapDescriptorFactory.fromResource(R.drawable.start_pos);
