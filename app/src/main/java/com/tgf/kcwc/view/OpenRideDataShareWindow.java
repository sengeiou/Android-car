 ...
 * 驾图报告分享窗口
 */
public class OpenRideDataShareWindow extends BottomPushPopupWindow<Void> {

    protected TextView title;
    protected GridView grid;
    protected TextView cancelBtn;

    public OpenRideDataShareWindow(Context context) {
        super(context, null);
    }

    @Override
    protected View generateCustomView(Void data) {
        View root = View.inflate(context, R.layout.open_share_bottom_window, null);
        ...
        String[] arrays = context.getResources().getStringArray(R.array.open_share_type2);
        int[] icons = { R.drawable.kcwc_share_logo, R.drawable.btn_weixin,
                        R.drawable.btn_pengyouquan, R.drawable.btn_weibo, R.drawable.btn_qq_icon,
                        R.drawable.btn_qq_zone, };
        int index = 0;
        for (String s : arrays) {
