...
//                    .setProgressBarImage(getContext().getResources().getDrawable(R.mipmap.ic_launcher)).build();
            .setProgressBarImage(R.mipmap.ic_launcher).build();
    ...
    public void setImageUri(Uri parse) {
        setImageUri(parse,null);
    }
}
