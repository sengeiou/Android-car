...
public class CountdownView extends View {
     ...
     * @param contentSize all book_line_content_list view size
    ...
    public void setmCountdownTextCo(int timeTextColor){
    ...
    public void customTimeShow(boolean isShowDay, boolean isShowHour, boolean isShowMinute,
        ...
        boolean isModCountdownInterval = mCountdown.refTimeShow(isShowDay, isShowHour, isShowMinute,
    ...
    public void settimeColor(int timeTextSize){
        mCountdown.setTimeTextColor(timeTextSize);
        mCountdown.initPaint();
    }
    ...
    public void dynamicShow(DynamicConfig dynamicConfig) {
        ...
        if (mCountdown.setSuffixMargin(suffixDayLeftMargin, suffixDayRightMargin,
            suffixHourLeftMargin, suffixHourRightMargin, suffixMinuteLeftMargin,
            suffixMinuteRightMargin, suffixSecondLeftMargin, suffixSecondRightMargin,
        ...
        if (null != tempIsShowDay || null != tempIsShowHour || null != tempIsShowMinute
            || null != tempIsShowSecond || null != tempIsShowMillisecond) {
            ...
            boolean isShowMinute = null != tempIsShowMinute ? tempIsShowMinute
                : mCountdown.isShowMinute;
            boolean isShowSecond = null != tempIsShowSecond ? tempIsShowSecond
                : mCountdown.isShowSecond;
