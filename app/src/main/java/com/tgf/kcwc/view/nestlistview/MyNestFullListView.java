...
public class MyNestFullListView extends LinearLayout {
    ...
    public MyNestFullListView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MyNestFullListView(Context context, AttributeSet attrs, int defStyleAttr) {
                    ...
                    holder.getConvertView().setOnClickListener(new OnClickListener() {
                        ...
                        public void onClick(View v) {
                            if (mOnItemClickListener != null && mAdapter != null) {
                                mOnItemClickListener.onItemClick(MyNestFullListView.this, v, mPosition);
                            }
                        }
                    });
                }
    ...
    public interface OnItemClickListener {
        ...
        void onItemClick(MyNestFullListView parent, View view, int position);
    }
