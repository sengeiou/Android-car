...
public class OutlineContainer extends FrameLayout implements Animatable
{
	...
	private void init()
	{
		...
		mOutlinePaint.setStrokeWidth(BitmapUtils.dp2px(getContext(), 2));
		mOutlinePaint.setColor(getResources().getColor(R.color.devider));
		mOutlinePaint.setStyle(Style.STROKE);

		int padding = BitmapUtils.dp2px(getContext(), 10);
	...
	protected void dispatchDraw(Canvas canvas)
	{
		...
		int offset = BitmapUtils.dp2px(getContext(), 5);
