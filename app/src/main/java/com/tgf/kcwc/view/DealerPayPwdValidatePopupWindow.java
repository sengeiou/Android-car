...
public class DealerPayPwdValidatePopupWindow extends BottomPushPopupWindow implements DealerWalletView<ResponseMessage> {
    ...
    public DealerPayPwdValidatePopupWindow(Context context, Object object) {
