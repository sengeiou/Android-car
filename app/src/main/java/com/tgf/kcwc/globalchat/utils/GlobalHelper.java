package com.tgf.kcwc.globalchat.utils;
...
import com.tgf.kcwc.globalchat.db.DemoDBManager;
import com.tgf.kcwc.globalchat.db.InviteMessgeDao;
import com.tgf.kcwc.globalchat.db.UserDao;
import com.tgf.kcwc.globalchat.domain.EmojiconExampleGroupData;
import com.tgf.kcwc.globalchat.domain.InviteMessage;
import com.tgf.kcwc.globalchat.domain.InviteMessage.InviteMessageStatus;
import com.tgf.kcwc.globalchat.domain.RobotUser;
import com.tgf.kcwc.globalchat.parse.UserProfileManager;
import com.tgf.kcwc.globalchat.receiver.CallReceiver;
import com.tgf.kcwc.globalchat.ui.VideoCallActivity;
import com.tgf.kcwc.globalchat.ui.VoiceCallActivity;
...
public class GlobalHelper {
    ...
    protected static final String TAG = "GlobalHelper";
    ...
    private GlobalModel demoModel = null;
    ...
    public void init(Context context) {
        demoModel = new GlobalModel(context);
    ...
    protected void setEaseUIProviders() {
        ...
        easeUI.setUserProfileProvider(new EaseUserProfileProvider() {
            ...
            public EaseUser getUser(String username) {
                ...
                if (username.equals(SharedPreferenceUtil.getEaseaUserName(appContext))) {
                    user.setAvatar(URLUtil.builderImgUrl(IOUtils.getAccount(appContext).userInfo.avatar, 144, 144));
                } else {
        ...
        easeUI.getNotifier().setNotificationInfoProvider(new EaseNotificationInfoProvider() {
            ...
            public Intent getLaunchIntent(EMMessage message) {
                ...
                Intent intent = new Intent(appContext, GlobalChatActivity.class);
...
//                     intent.putExtra( Constants.IntentParams.SHOW_LOGINOUT, 1);
...
//                    appContext.startActivity(intent);
                ...
                Logger.d("easechat connect 连接失败code==" + error);
                if (error == EMError.USER_REMOVED) {
                    onUserException(Constant.ACCOUNT_REMOVED);
                    Logger.d("easechat  EMError.USER_REMOVED");
                } else if (error == EMError.USER_LOGIN_ANOTHER_DEVICE) {
//                    onUserException(Constant.ACCOUNT_CONFLICT);
                    Logger.d("easechat login 环信帐号已在其他设备登录");

                } else if (error == EMError.SERVER_SERVICE_RESTRICTED) {
                    onUserException(Constant.ACCOUNT_FORBIDDEN);
                    Logger.d("easechat  SERVER_SERVICE_RESTRICTED");
                } else if (error == EMError.USER_KICKED_BY_CHANGE_PASSWORD) {
                    onUserException(Constant.ACCOUNT_KICKED_BY_CHANGE_PASSWORD);
                    Logger.d("easechat  USER_KICKED_BY_CHANGE_PASSWORD");
                } else if (error == EMError.USER_KICKED_BY_OTHER_DEVICE) {
                    Logger.d("easechat  USER_KICKED_BY_OTHER_DEVICE");
            ...
            public void onConnected() {
                Logger.d("easechat connect 连接成功");
    ...
    public class MyContactListener implements EMContactListener {
        ...
        public void onContactDeleted(String username) {
            Map<String, EaseUser> localUsers = GlobalHelper.getInstance().getContactList();
...
/*
     ...
     * @param userPic
     */
    public void saveUser(String hxIdFrom, String userName, String userPic) {
        ...
        RxBus.$().post(Constants.IntentParams.MESSAGEREFRESH, Constants.IntentParams.MESSAGEREFRESH);
    }
        ...
        messageListener = new EMMessageListener() {
            ...
            public void onMessageReceived(List<EMMessage> messages) {
                ...
                for (EMMessage message : messages) {
                    ...
                    Logger.d("onMessageReceived", message.getBody());
                    // in background, do not refresh UI, notify it in notification bar
                    if (!easeUI.hasForegroundActivies()) {
                        getNotifier().onNewMsg(message);
                    }
                    String type = message.getStringAttribute("model", "");
                    if (!TextUtil.isEmpty(type)) {
                        if (type.equals("buycar")) {
                            appContext.sendBroadcast(new Intent("com.tgf.kcwc.seecar"));
                        }
                    }
                }
                RxBus.$().post(Constants.IntentParams.MESSAGEREFRESH, Constants.IntentParams.MESSAGEREFRESH);
    ...
    public void logout(boolean unbindDeviceToken, final EMCallBack callback) {
        ...
        if (Constants.IS_TEST) {
            CommonUtils.showToast(appContext, "环信退出登录");
        }
