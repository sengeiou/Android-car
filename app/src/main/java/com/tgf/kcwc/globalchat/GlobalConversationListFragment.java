...
import com.tgf.kcwc.globalchat.base.GlobalEaseConversationListFragment;
 ...
 * 聊天列表
 */
public class GlobalConversationListFragment extends GlobalEaseConversationListFragment {
        ...
        conversationListView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (username.equals(EMClient.getInstance().getCurrentUser()))
                    ...
                    //intent.putExtra(Constant.EXTRA_USER_NICKNAME, userName);
