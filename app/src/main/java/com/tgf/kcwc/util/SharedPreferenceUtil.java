...
public class SharedPreferenceUtil {
    ...
    private static final String KEY_SP__UPDATEURL= "updateurl"; //获取城市列表时间
    ...
    private static final String KEY_SP_THREAD_ID = "thread_id";//提交申请时的id
    ...
    public static int getThreadId(Context context) {
        SharedPreferences sp = context.getSharedPreferences(spFile, Context.MODE_PRIVATE);
        return sp.getInt(KEY_SP_THREAD_ID, 0);
    }
