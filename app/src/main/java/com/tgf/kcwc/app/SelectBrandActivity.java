...
public class SelectBrandActivity extends BaseActivity
    ...
    private static final String TAG = SelectBrandActivity.class
            .getSimpleName();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mMoudleType = intent.getStringExtra(Constants.IntentParams.MODULE_TYPE);
    ...
    public void onItemClick(ViewGroup parent, View view, Brand item, int position) {
        ...
        args.put(Constants.IntentParams.MODULE_TYPE, mMoudleType);
    ...
    public void showData(List<Brand> data) {
        ...
        mRv.addItemDecoration(new DividerItemDecoration(SelectBrandActivity.this,
