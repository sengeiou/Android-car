...
public class MyGridViewAdapter extends BaseAdapter {
    ...
    public MyGridViewAdapter(Context context,List<ProductListBean> listData,int mIndex,int mPagerSize,MyOnClickListener myOnClickListener) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            convertView = inflater.inflate(R.layout.plussign_item_gridview,parent,false);
        ...
        convertView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                myOnClickListener.onClick(listData.get(pos));
            }
        });
        return convertView;
    }
    ...
    public interface MyOnClickListener{
       void onClick(ProductListBean productListBean);
    }
}
