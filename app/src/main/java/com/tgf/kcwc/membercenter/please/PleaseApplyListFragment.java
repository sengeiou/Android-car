...
public class PleaseApplyListFragment extends BaseFragment implements PleaseApplyListView {
    ...
    private PleaseAppListPresenter mPleaseAppListPresenter;
    private WrapAdapter<PleaseAppBean.DataList> mAdapter;
    public List<PleaseAppBean.DataList> dataList = new ArrayList<>();
    ...
    protected void initView() {
        ...
        mPleaseAppListPresenter = new PleaseAppListPresenter();
        mPleaseAppListPresenter.attachView(this);
        ...
        mHintLayout.setOperation("报名活动", "报名活动", R.color.text_color6, new Link.OnClickListener() {
            ...
            public void onClick(Object o, String clickedText) {
                ...
                //CommonUtils.startNewActivity(mContext, com.tgf.kcwc.driving.please.PleasePlayActivity.class);
            }
        });
        mHintLayout.setVisibility(View.GONE);
        mListView.setVisibility(View.VISIBLE);

        mAdapter = new WrapAdapter<PleaseAppBean.DataList>(mContext, dataList,
                R.layout.menmber_pleaseapp_item) {
            @Override
            public void convert(ViewHolder helper, final PleaseAppBean.DataList item) {
                ...
                drive.setOnClickListener(new View.OnClickListener() { //驾途
                    ...
                    public void onClick(View v) {
                        Map<String, Serializable> args = new HashMap<String, Serializable>();
                        args.put(Constants.IntentParams.THREAD_ID, item.threadId);
    ...
    @Override
    public void dataListSucceed(PleaseAppBean appListBean) {
    ...
    public void onDestroy() {
        super.onDestroy();
        if (mPleaseAppListPresenter != null) {
            mPleaseAppListPresenter.detachView();
        }
    }
    ...
    private void showQR(final String id) {
        ...
        mendgroup.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mPleaseAppListPresenter.getActivityCancel(IOUtils.getToken(mContext), id);
                alertDialog.dismiss();
            }
        });
    ...
    public void loadMore() {
        mPleaseAppListPresenter.gainAppLsis(IOUtils.getToken(mContext), page);
    }
