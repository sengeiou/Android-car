...
import com.tgf.kcwc.mvp.presenter.SponsorDrivingPresenter;
...
public class SponsorDrivingActivity extends BaseActivity implements SponsorDrivingView {

    private FileUploadPresenter mFileUploadPresenter;                           //上传图片
    private SponsorDrivingPresenter mSponsorDrivingPresenter;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSponsorDrivingPresenter = new SponsorDrivingPresenter();
        mSponsorDrivingPresenter.attachView(this);
        ...
        mExplainAdapter = new WrapAdapter<SEditorData>(mContext, R.layout.activity_drivdetails_item,
                mEditorDatas) {
            @Override
            public void convert(ViewHolder helper, final SEditorData item) {
        ...
        ViewUtil.link(" 活动协议", mAgreement, new Link.OnClickListener() {
            ...
            public void onClick(Object o, String clickedText) {
                ...
                args.put(Constants.IntentParams.ID, "3");
    ...
    private void uploadImage(ImageItem item) {
        ...
        Log.i("TT", "有多长==" + f.length() + "路径==" + item.path);
    ...
    private FileUploadView<DataItem> uploadView = new FileUploadView<DataItem>() {
        ...
        public void resultData(DataItem dataItem) {
            if (dataItem.code == 0) {
                ...
                mDrivdetailsCover.setImageURI(Uri.parse(URLUtil.builderImgUrl(dataItem.resp.data.path, 540, 304)));
            } else {
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.scene_type: //选择类型
                ...
                mDropUpPopupWindow.show(SponsorDrivingActivity.this);
            ...
            case R.id.sponsord_project: //计划路线
                Map<String, Serializable> args = new HashMap<String, Serializable>();
                args.put(Constants.IntentParams.INTENT_TYPE, Constants.PathBack.SPONSORDRIVING_SUCCEED);
    ...
    public void Confirm() {
        ...
        if (mTypeDataItem.id == 6 || mTypeDataItem.id == 7) {
            mSponsorDrivingPresenter.getCreate(builderParams());
        } else {
            mSponsorDrivingPresenter.getCreate(builderParams1());
        }
    ...
    protected void onDestroy() {
        ...
        if (mSponsorDrivingPresenter != null) {
            mSponsorDrivingPresenter.detachView();
        }
    }
