...
public class ImageTailorActivity extends ImageBaseActivity implements View.OnClickListener, CropImageView.OnBitmapSaveCompleteListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setData(3, "4:3",R.drawable.to3,R.drawable.to3b,false);
        setData(4, "3:4",R.drawable.to4,R.drawable.to4b,false);
        setData(5, "16:9",R.drawable.to9,R.drawable.to9b,false);
        setData(6, "9:16",R.drawable.to16,R.drawable.to16b,false);
